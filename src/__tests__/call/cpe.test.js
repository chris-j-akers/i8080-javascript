...
describe('CPE', () => {
	it('Parity is set (Even Parity), call is made', () => {
		...
		let program = [
		  ...
		  assert.equal(c.CPUState.Registers['A'], 21);
	...
	it('Parity is not set (Odd Parity), call is not made', () => {
		const c = new Computer();
		const FlagType = c._cpu._flagManager.FlagType;
		...
		let program = [
		  ...
		  10,          // ...this byte
		  0xC6,                   // ADI...
		  9,                  // ...This immediate value from accumulator
		  0xEC,                   // CPE
		  0xAA,                   // ...low-byte of address
		  0xAA,                   // ...high-byte of address
		  0x76,                   // HALT
